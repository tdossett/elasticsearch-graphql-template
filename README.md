...
Note: package: 'apollo-server-express' is the Express and Connect integration of GraphQL Server. In addtion all GraphQL 'queries' are demonstrated using Elasticsearch index: 'vueelastic' while 'mutations' are demonstrated using index: 'blacksopedia'.
